...
type IncomingDatagram struct {
	...
	RemoteAddress wasi_sockets_network.IpSocketAddress
}
...
type OutgoingDatagram struct {
	...
	RemoteAddress witTypes.Option[wasi_sockets_network.IpSocketAddress]
}
...
func (self *UdpSocket) StartBind(network *wasi_sockets_network.Network, localAddress wasi_sockets_network.IpSocketAddress) witTypes.Result[witTypes.Unit, wasi_sockets_network.ErrorCode] {
...
func (self *UdpSocket) FinishBind() witTypes.Result[witTypes.Unit, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) Stream(remoteAddress witTypes.Option[wasi_sockets_network.IpSocketAddress]) witTypes.Result[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result witTypes.Result[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = witTypes.Ok[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_network.ErrorCode](witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream]{IncomingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))), OutgoingDatagramStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))})
	case 1:

		result = witTypes.Err[witTypes.Tuple2[*IncomingDatagramStream, *OutgoingDatagramStream], wasi_sockets_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result23 := result
...
func (self *UdpSocket) LocalAddress() witTypes.Result[wasi_sockets_network.IpSocketAddress, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) RemoteAddress() witTypes.Result[wasi_sockets_network.IpSocketAddress, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) AddressFamily() wasi_sockets_network.IpAddressFamily {
...
func (self *UdpSocket) UnicastHopLimit() witTypes.Result[uint8, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetUnicastHopLimit(value uint8) witTypes.Result[witTypes.Unit, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) ReceiveBufferSize() witTypes.Result[uint64, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetReceiveBufferSize(value uint64) witTypes.Result[witTypes.Unit, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SendBufferSize() witTypes.Result[uint64, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *UdpSocket) SetSendBufferSize(value uint64) witTypes.Result[witTypes.Unit, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *IncomingDatagramStream) Receive(maxResults uint64) witTypes.Result[[]IncomingDatagram, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result0 witTypes.Result[[]IncomingDatagram, wasi_sockets_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:
		...
		for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (2 * 4)))); index++ {
			...
			case 0:
				...
				variant = wasi_sockets_network.MakeIpSocketAddressIpv4(wasi_sockets_network.Ipv4SocketAddress{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), witTypes.Tuple4[uint8, uint8, uint8, uint8]{uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (6 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (7 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4))))), uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (9 + 2*4)))))}})

			case 1:

				variant = wasi_sockets_network.MakeIpSocketAddressIpv6(wasi_sockets_network.Ipv6SocketAddress{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (4 + 2*4))))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (8 + 2*4)))), witTypes.Tuple8[uint16, uint16, uint16, uint16, uint16, uint16, uint16, uint16]{uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (12 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (14 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (16 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (18 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (20 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (22 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (24 + 2*4))))), uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(base), (26 + 2*4)))))}, uint32(*(*int32)(unsafe.Add(unsafe.Pointer(base), (28 + 2*4))))})
		...
		result0 = witTypes.Ok[[]IncomingDatagram, wasi_sockets_network.ErrorCode](result)
	case 1:

		result0 = witTypes.Err[[]IncomingDatagram, wasi_sockets_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))))
	default:
		panic("unreachable")
	}
	result1 := result0
...
func (self *OutgoingDatagramStream) CheckSend() witTypes.Result[uint64, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
...
func (self *OutgoingDatagramStream) Send(datagrams []OutgoingDatagram) witTypes.Result[uint64, wasi_sockets_network.ErrorCode] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()
	...
	var result0 witTypes.Result[uint64, wasi_sockets_network.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result0 = witTypes.Ok[uint64, wasi_sockets_network.ErrorCode](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 8))))
	case 1:

		result0 = witTypes.Err[uint64, wasi_sockets_network.ErrorCode](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))))
	default:
		panic("unreachable")
	}
	result1 := result0
