...
import (
	...
	"github.com/jamesstocktonj1/componentize-sdk/gen/wasi_clocks_wall_clock"
	"github.com/jamesstocktonj1/componentize-sdk/gen/wasi_otel_types"
	"runtime"
	"unsafe"
)
...
//go:wasmimport wasi:otel/tracing@0.2.0-rc.1 on-start
...
//go:wasmimport wasi:otel/tracing@0.2.0-rc.1 on-end
...
//go:wasmimport wasi:otel/tracing@0.2.0-rc.1 outer-span-context
