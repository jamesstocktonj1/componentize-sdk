...
func wasm_export_wasi_http_handler_handle(arg0 int32) int32 {
	return int32(witAsync.Run(func() {
		...
		result := export_wasi_http_handler.Handle(wasi_http_types.RequestFromOwnHandle(int32(uintptr(arg0))))
		var option70 int32
		var option71 int32
		var option72 int32
		var option73 int64
		...
		case witTypes.ResultErr:
			...
			var variant69 int32
			switch payload.Tag() {
			case wasi_http_types.ErrorCodeDnsTimeout:
			...
			case wasi_http_types.ErrorCodeDnsError:
			...
			case wasi_http_types.ErrorCodeDestinationNotFound:
			...
			case wasi_http_types.ErrorCodeDestinationUnavailable:
			...
			case wasi_http_types.ErrorCodeDestinationIpProhibited:
			...
			case wasi_http_types.ErrorCodeDestinationIpUnroutable:
			...
			case wasi_http_types.ErrorCodeConnectionRefused:
			...
			case wasi_http_types.ErrorCodeConnectionTerminated:
			...
			case wasi_http_types.ErrorCodeConnectionTimeout:
			...
			case wasi_http_types.ErrorCodeConnectionReadTimeout:
			...
			case wasi_http_types.ErrorCodeConnectionWriteTimeout:
			...
			case wasi_http_types.ErrorCodeConnectionLimitReached:
			...
			case wasi_http_types.ErrorCodeTlsProtocolError:
			...
			case wasi_http_types.ErrorCodeTlsCertificateError:
			...
			case wasi_http_types.ErrorCodeTlsAlertReceived:
			...
			case wasi_http_types.ErrorCodeHttpRequestDenied:
			...
			case wasi_http_types.ErrorCodeHttpRequestLengthRequired:
			...
			case wasi_http_types.ErrorCodeHttpRequestBodySize:
			...
			case wasi_http_types.ErrorCodeHttpRequestMethodInvalid:
			...
			case wasi_http_types.ErrorCodeHttpRequestUriInvalid:
			...
			case wasi_http_types.ErrorCodeHttpRequestUriTooLong:
			...
			case wasi_http_types.ErrorCodeHttpRequestHeaderSectionSize:
			...
			case wasi_http_types.ErrorCodeHttpRequestHeaderSize:
			...
			case wasi_http_types.ErrorCodeHttpRequestTrailerSectionSize:
			...
			case wasi_http_types.ErrorCodeHttpRequestTrailerSize:
			...
			case wasi_http_types.ErrorCodeHttpResponseIncomplete:
			...
			case wasi_http_types.ErrorCodeHttpResponseHeaderSectionSize:
			...
			case wasi_http_types.ErrorCodeHttpResponseHeaderSize:
			...
			case wasi_http_types.ErrorCodeHttpResponseBodySize:
			...
			case wasi_http_types.ErrorCodeHttpResponseTrailerSectionSize:
			...
			case wasi_http_types.ErrorCodeHttpResponseTrailerSize:
			...
			case wasi_http_types.ErrorCodeHttpResponseTransferCoding:
			...
			case wasi_http_types.ErrorCodeHttpResponseContentCoding:
			...
			case wasi_http_types.ErrorCodeHttpResponseTimeout:
			...
			case wasi_http_types.ErrorCodeHttpUpgradeFailed:
			...
			case wasi_http_types.ErrorCodeHttpProtocolError:
			...
			case wasi_http_types.ErrorCodeLoopDetected:
			...
			case wasi_http_types.ErrorCodeConfigurationError:
			...
			case wasi_http_types.ErrorCodeInternalError:
		...
		wasm_export_task_return_wasi_http_handler_handle(option70, option71, option72, option73, option74, option75, option76, option77)

	}))
}

//go:wasmexport [callback][async-lift]wasi:http/handler@0.3.0-rc-2026-03-15#handle
func wasm_export_callback_wasi_http_handler_handle(event0 uint32, event1 uint32, event2 uint32) uint32 {
...
func wasm_export_task_return_wasi_http_handler_handle(arg0 int32, arg1 int32, arg2 int32, arg3 int64, arg4 uintptr, arg5 uintptr, arg6 uint32, arg7 int32)
