...
package wasi_io_0_2_1_streams

import (
	"github.com/jamesstocktonj1/componentize-sdk/gen/wasi_io_0_2_1_error"
	"github.com/jamesstocktonj1/componentize-sdk/gen/wasi_io_0_2_1_poll"
...
type Error = wasi_io_0_2_1_error.Error
type Pollable = wasi_io_0_2_1_poll.Pollable
...
func (self StreamError) LastOperationFailed() *wasi_io_0_2_1_error.Error {
	if self.tag != StreamErrorLastOperationFailed {
		panic("tag mismatch")
	}
	return self.value.(*wasi_io_0_2_1_error.Error)
}

func MakeStreamErrorLastOperationFailed(value *wasi_io_0_2_1_error.Error) StreamError {
...
func (self *InputStream) Read(len uint64) witTypes.Result[[]uint8, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_1_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), (4 + 1*4)))))))
...
func (self *InputStream) Skip(len uint64) witTypes.Result[uint64, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_1_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 12))))))
...
func (self *InputStream) Subscribe() *wasi_io_0_2_1_poll.Pollable {

	result := wasm_import_method_input_stream_subscribe((self).Handle())
	return wasi_io_0_2_1_poll.PollableFromOwnHandle(int32(uintptr(result)))
...
func (self *OutputStream) Write(contents []uint8) witTypes.Result[witTypes.Unit, StreamError] {
	...
	case 1:
		...
		case 0:
			...
			variant = MakeStreamErrorLastOperationFailed(wasi_io_0_2_1_error.ErrorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8))))))
...
func (self *OutputStream) Subscribe() *wasi_io_0_2_1_poll.Pollable {
